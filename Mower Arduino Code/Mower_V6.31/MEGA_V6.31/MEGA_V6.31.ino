...
char TRS_MOW_TIME_MAX[] = "Max Mow Time";
char TRS_MOW_TIME_1HR[] = "1hr Mow Time";
char TRS_MOW_TIME_2HR[] = "2hr Mow Time";
char TRS_H_LOCK_LEFT[] = "<H-Lock Mow ";
char TRS_H_LOCK_RIGHT[] = " H-Lock Mow>";
char TRS_H_LOCK_OK[] = "|H-Lock Mow|";
char TRS_MAX_MOW[] = "Max Mow";
char TRS_SELECTED[]= "Selected";
char TRS_1HR_MOW_SELECTED[] = "1hr Mow Selected";
char TRS_ENDS_[] = "Ends: ";
char TRS_2HR_MOW_SELECTED[] = "2hr Mow Selected";
char TRS_MOW_GRASS__[] = "Mow Grass     ";
char TRS_GO_TO_DOCK[] = "Go To Dock";
char TRS_DOCK_REMOVED[] = "Dock Removed";
char TRS_MOW_RE_STARTING[] = "Mow Re-Starting";
char TRS_RETURNING_HOME[] = "Returning Home";
char TRS_NO_DOCK_ACTIVE[] = "No Dock Active";
...
char TRS_DOCKED[] = "Nel Box";
char TRS_CHARGING[] = "Ricarica";
...
char TRS_COMPASS_HOME[] = "Cerca Box(B)";//tramite bussola
char TRS_TARGET[] = "Obiettivo:";
char TRS_DOCKED_IN[] = "Nel Box";
...
char TRS_TRAMPOLINE_CUT[] = "Taglio preciso";
char TRS_MOW_THE_LINE[] = "Segui il cavo";
char TRS_TEST_MENU[] = "Test Menu";
char TRS_SETUP_MOWER[] = "Setup Robot";
char TRS_MANUAL_START[] = "Manual Start";
char TRS_BLADE_WILL_SPIN[] = "Blade will spin";
char TRS_MOW_TIME_MAX[] = "Tempo Massimo";
char TRS_MOW_TIME_1HR[] = "1 ora";
char TRS_MOW_TIME_2HR[] = "2 ore";
char TRS_H_LOCK_LEFT[] = "<  Taglio   ";
char TRS_H_LOCK_RIGHT[] = "   Taglio  >";
char TRS_H_LOCK_OK[] = "|  Taglio  |";
char TRS_MAX_MOW = "Massimo";
char TRS_SELECTED= "Selez.";
char TRS_1HR_MOW_SELECTED = "1 ora di taglio";
char TRS_ENDS_ = "Fine: ";
char TRS_2HR_MOW_SELECTED = "2 ore di taglio";
char TRS_MOW_GRASS__[] = "Taglia erba";
char TRS_GO_TO_DOCK[] = "Torna nel box";
char TRS_DOCK_REMOVED[] = "Box rimosso";
char TRS_MOW_RE_STARTING[] = "Riavvia taglio";
char TRS_RETURNING_HOME[] = "Torna nel box";
char TRS_NO_DOCK_ACTIVE[] = "Nessun box attiv";
...
#define USE_CABLEPin 11 //Pin per controllare se usare o no il cavo
...
bool Perimeter_Wire_Enabled     = 1;//[PERIMETRO=1] ATTENZIONE viene pilotato dal pin11                         // Activates use of the perimeter boundary wire [PERIMETRO=1]
int cable_mag_sensibility = 3; //default 20
...
//Docking Station
bool Use_Charging_Station       = 1;//[PERIMETRO=1]                          // 1 if you are using the docking/charging station     0 if not
bool CW_Tracking_To_Charge      = 1;//[PERIMETRO=1]                         // Clock-Wise         tracking around the boundary wire to the charging station
...
bool CCW_Tracking_To_Start      = 1;//[PERIMETRO=1]                         // Counter-Clock-Wise tracking around the boundary wire to the charging station
...
void setup() {
  Serial.begin(115200);
  //2021-10-23 tolto nanoSerial1.begin(1200);									// Open Serial port 1 for the nano communication
  ...
  pinMode(USE_CABLEPin, INPUT);
  Perimeter_Wire_Enabled = digitalRead(USE_CABLEPin);
