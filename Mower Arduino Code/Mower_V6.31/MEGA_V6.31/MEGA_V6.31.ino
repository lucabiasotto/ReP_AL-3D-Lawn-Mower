...
bool Perimeter_Wire_Enabled     = 1; // ATTENZIONE viene pilotato dal pin11, Activates use of the perimeter boundary wire 
...
void loop() {
    ...
    lcdPrintVoltInfo();// Print the voltage to the LCD screen
